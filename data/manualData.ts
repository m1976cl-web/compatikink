...
registerCustomActivity(newCustomActivity);`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    keyFeatures: [
      'Derivación de clave mediante PBKDF2 / Argon2 desde el PIN del usuario',
      'Cifrado local transparente antes de persistir en AsyncStorage o Supabase',
      'Borrado remoto / Destrucción rápida en caso de PIN de pánico',
      'Almacenamiento de claves criptográficas en SecureStore / Keychain nativo',
    ],
    stepByStepGuide: [
  ...
  },
  {
    ...
    keyFeatures: [
      'Autenticación por PIN de Administrador (ej. PIN 9999)',
