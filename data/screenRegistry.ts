...
export const SCREEN_REGISTRY: Record<string, ScreenClassification> = {
  ...
  '/marketplace-dark': { route: '/marketplace-dark', status: 'preview', badge: '🚧 Beta' },
  '/foot-fetish': { route: '/foot-fetish', status: 'preview', badge: '🚧 Beta' },
  '/tribute': { route: '/tribute', status: 'preview', badge: '🚧 Beta' },
  '/sissy-training': { route: '/sissy-training', status: 'preview', badge: '🚧 Beta' },
  '/leisure': { route: '/leisure', status: 'preview', badge: '🚧 Beta' },
  ...
  '/chastity-wearer': { route: '/chastity-wearer', status: 'preview', badge: '🚧 Beta' },
  '/chastity-keyholder': { route: '/chastity-keyholder', status: 'preview', badge: '🚧 Beta' },
  '/chastity-protocol': { route: '/chastity-protocol', status: 'preview', badge: '🚧 Beta' },
  '/chastity-tools': { route: '/chastity-tools', status: 'preview', badge: '🚧 Beta' },
  '/chastity-cage': { route: '/chastity-cage', status: 'preview', badge: '🚧 Beta' },
  '/chastity-belt': { route: '/chastity-belt', status: 'preview', badge: '🚧 Beta' },
  '/chastity-fit': { route: '/chastity-fit', status: 'preview', badge: '🚧 Beta' },
