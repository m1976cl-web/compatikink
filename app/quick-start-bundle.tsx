...
const styles = StyleSheet.create({
  ...
  quoteRole: { fontSize: 10, fontWeight: '900', color: colors.textMuted },
  ...
  protoRole: { color: colors.textMuted, fontSize: 10 },
  ...
  checkStatusText: { fontSize: 10, color: colors.textMuted, fontWeight: '700' },
