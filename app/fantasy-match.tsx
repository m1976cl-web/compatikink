...
const styles = StyleSheet.create({
  ...
  privacyAlert: { backgroundColor: 'rgba(74, 222, 128, 0.1)', padding: spacing.md, borderRadius: 14, borderWidth: 1, borderColor: colors.success, marginVertical: spacing.xs },
  ...
  rateBtn: { flex: 1, paddingVertical: 10, borderRadius: 12, backgroundColor: colors.surfaceLight, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  ...
  revealBtn: { backgroundColor: colors.primary, paddingVertical: spacing.md, borderRadius: 16, alignItems: 'center' },
  ...
  matchCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surfaceLight, padding: spacing.md, borderRadius: 16, borderWidth: 1.5, borderColor: colors.success, gap: spacing.md },
